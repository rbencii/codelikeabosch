class Predict:
    ...
    def createPred(self, objects, time=0.1): #after render
        ...
        for obj in closeObjecs:
            self.predictions.append({"x":obj["x"] + time*obj["vx"],"y":obj["y"] + time*obj["vy"],"vx":obj["vx"],"vy":obj["vy"],"type":obj["type"] if "type" in obj else 0, "lifeSpan":obj["lifeSpan"]-time if "lifeSpan" in obj else 3.0})
        ...
        for obj in oldPredictions:
            if obj["x"] < 10 and obj["x"] > -10 and obj["y"] < 10 and obj["y"] > -10:
                closeObjecs.append(obj)
        for obj in closeObjecs:
            self.predictions.append({"x":obj["x"] + time*obj["vx"],"y":obj["y"] + time*obj["vy"],"vx":obj["vx"],"vy":obj["vy"],"type":obj["type"] if "type" in obj else 0, "lifeSpan":obj["lifeSpan"]-time})
