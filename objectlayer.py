...
class Objects:
    ...
    def __update__(self,limitMargin = 0.2):
        ...
        self.realObjects = []
        self.time = self.database[self.iterator][0]
        ...
        for i in self.cameraPersonas:
            self.cameraPersonas[i]["x"] = self.database[self.iterator][self.cameraPersonas[i]["xIndex"]]
            self.cameraPersonas[i]["y"] = self.database[self.iterator][self.cameraPersonas[i]["yIndex"]]
            self.cameraPersonas[i]["vx"] = self.database[self.iterator][self.cameraPersonas[i]["vxIndex"]]
            self.cameraPersonas[i]["vy"] = self.database[self.iterator][self.cameraPersonas[i]["vyIndex"]]
            self.cameraPersonas[i]["type"] = self.database[self.iterator][self.cameraPersonas[i]["typeIndex"]]
        for i in self.leftFrontRadarPersonas:
            self.leftFrontRadarPersonas[i]["x"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["xIndex"]]
            self.leftFrontRadarPersonas[i]["y"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["yIndex"]]
            self.leftFrontRadarPersonas[i]["z"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["zIndex"]]
            self.leftFrontRadarPersonas[i]["vx"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["vxIndex"]]
            self.leftFrontRadarPersonas[i]["vy"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["vyIndex"]]
            self.leftFrontRadarPersonas[i]["ax"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["axIndex"]]
            self.leftFrontRadarPersonas[i]["ay"] = self.database[self.iterator][self.leftFrontRadarPersonas[i]["ayIndex"]]
        for i in self.leftRearRadarPersonas:
            self.leftRearRadarPersonas[i]["x"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["xIndex"]]
            self.leftRearRadarPersonas[i]["y"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["yIndex"]]
            self.leftRearRadarPersonas[i]["z"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["zIndex"]]
            self.leftRearRadarPersonas[i]["vx"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["vxIndex"]]
            self.leftRearRadarPersonas[i]["vy"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["vyIndex"]]
            self.leftRearRadarPersonas[i]["ax"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["axIndex"]]
            self.leftRearRadarPersonas[i]["ay"] = self.database[self.iterator][self.leftRearRadarPersonas[i]["ayIndex"]]
        for i in self.rightFrontRadarPersonas:
            self.rightFrontRadarPersonas[i]["x"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["xIndex"]]
            self.rightFrontRadarPersonas[i]["y"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["yIndex"]]
            self.rightFrontRadarPersonas[i]["z"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["zIndex"]]
            self.rightFrontRadarPersonas[i]["vx"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["vxIndex"]]
            self.rightFrontRadarPersonas[i]["vy"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["vyIndex"]]
            self.rightFrontRadarPersonas[i]["ax"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["axIndex"]]
            self.rightFrontRadarPersonas[i]["ay"] = self.database[self.iterator][self.rightFrontRadarPersonas[i]["ayIndex"]]
        for i in self.rightRearRadarPersonas:
            self.rightRearRadarPersonas[i]["x"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["xIndex"]]
            self.rightRearRadarPersonas[i]["y"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["yIndex"]]
            self.rightRearRadarPersonas[i]["z"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["zIndex"]]
            self.rightRearRadarPersonas[i]["vx"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["vxIndex"]]
            self.rightRearRadarPersonas[i]["vy"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["vyIndex"]]
            self.rightRearRadarPersonas[i]["ax"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["axIndex"]]
            self.rightRearRadarPersonas[i]["ay"] = self.database[self.iterator][self.rightRearRadarPersonas[i]["ayIndex"]]
